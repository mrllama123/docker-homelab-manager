...
async def volumes(request: Request):
    ...
    return templates.TemplateResponse(request, "tabs/backup_volumes/components/volume_rows.html", {"volumes": volumes})
...
def backup_volume_tab(request: Request):
    return templates.TemplateResponse(request, "tabs/backup_volumes/backup_volume_tab.html")
...
async def backups(request: Request, session: Session = Depends(get_session)):
    ...
    return templates.TemplateResponse(request, "tabs/backup_volumes/components/backup_rows.html", {"backups": backups})
...
def backup_schedules(request: Request):
    ...
    return templates.TemplateResponse(
        request, "tabs/backup_volumes/components/backup_schedule_rows.html", {"schedules": schedules}
    )
...
def create_backup_schedule_form(request: Request, volume_name: str):
    if request.headers.get("HX-Target") == "create-schedule-window":
        return ""
    return templates.TemplateResponse(
        request, "tabs/backup_volumes/components/create_backup_schedule.html", {"volume_name": volume_name}
    )
